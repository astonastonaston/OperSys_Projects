...
#define FCB_SIZE 44 //44 bytes per FCB
#define FCB_ENTRIES 1024

#define VOLUME_SIZE 1097728 
//4096+45056+1048576
// 4k -> free-space management bitmap region
// 44k (44 * 1k) -> 1k FCBs
// 1024k -> 32k(个block) * 32(Bytes per block) / 1024(max size per file) * 1k(max file number)

#define STORAGE_BLOCK_SIZE 32

#define MAX_FILENAME_SIZE 20
#define MAX_FILE_NUM 1024
#define MAX_FILE_SIZE 1048576 // 1024k file space size

#define FILE_BASE_ADDRESS 49152 //4096+45056 (4k + 44k) base addr of file space
...
int main() {
  ...
  // reset stack limit
  cudaDeviceSetLimit(cudaLimitStackSize, 1 << 18);
